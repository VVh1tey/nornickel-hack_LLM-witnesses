"""FastAPI по контракту, согласованному с фронтом (см. PLAN.md, план слияния):
    ...
    POST /api/sessions/{id}/hypotheses/{hid}/feedback       -> HITL approve/reject/skip
...
from hypofactory.pipeline.ranker import rerank as rerank_hypotheses
...
async def create_session(
    ...
    session = SessionState(session_id, goal, constraints, parsed_weights)
    await save_session(session)
